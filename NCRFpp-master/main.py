...
if __name__ == '__main__':
    ...
    parser.add_argument('--config',  help='Configuration File' )    # type indicates value type

    args = parser.parse_args()      # use args.<parameter_name> to get value of parameter, without '--'
