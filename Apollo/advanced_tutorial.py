...
# https://pytorch.org/tutorials/beginner/nlp/advanced_tutorial.html#sphx-glr-download-beginner-nlp-advanced-tutorial-py
# some comments by Jiaxin Zhang
...
def log_sum_exp(vec):
    ...
    return max_score + \
        torch.log(torch.sum(torch.exp(vec - max_score_broadcast)))          # substract the max_score in order to prevent from overload
